...
<body class="mb-48 bg-light-blue-200">
  <nav class="flex justify-between items-center mb-4 bg-blue-500 h-[10vh] text-white">
    <span class="font-bold uppercase ml-3">
              FYP Open House @auth{{auth()->user()->name}}@endauth
    </span>
